<h1>{{modeDesc}}</h1>
<section class="row">
    <form method="post" action="index.php?page=Mantenimientos_Productos_ProductosForm&mode={{mode}}&productId={{productId}}" class="col-6 offset-3">
        ...
        <div class="row right">
            {{if showAction}}
            <button><a href="index.php?page=Mantenimientos_Productos_ProductosList">Cancel</a></button>
            {{endif showAction}}
            {{ifnot showAction}}
            <button><a href="index.php?page=Mantenimientos_Productos_ProductosList">Volver a catalogo</a></button>
            {{endifnot showAction}}
